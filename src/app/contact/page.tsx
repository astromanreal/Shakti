...
const pageTitle = "Connect With Us - Shakti Darshan";
const pageDescription = "We're thrilled to hear from you! Whether you have questions, feedback, or just want to say hello, here’s how you can reach out to the Shakti Darshan team.";

export const metadata: Metadata = {
  title: pageTitle,
  description: pageDescription,
  keywords: ["Contact Shakti Darshan", "get in touch", "support", "feedback", "Shakti Darshan email", "Shakti Darshan social media"],
  openGraph: {
    title: pageTitle,
    description: pageDescription,
    url: '/contact',
    images: [
      {
        url: `https://picsum.photos/seed/contact-shakti-darshan/1200/630`, 
        width: 1200,
        height: 630,
        alt: 'Connect with Shakti Darshan',
      },
    ],
  },
  twitter: {
    title: pageTitle,
    description: pageDescription,
    images: [`https://picsum.photos/seed/contact-shakti-darshan/1200/630`],
  },
};
  ...
  return (
    <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="grid lg:grid-cols-2 gap-10 mb-16">
        {/* Direct Contact Card */}
        <Card className="shadow-xl rounded-xl border-2 border-primary/20 bg-gradient-to-br from-card via-background to-muted/30 overflow-hidden transform transition-all duration-300 ease-in-out hover:shadow-2xl hover:-translate-y-1 hover:scale-[1.02]">
        ...
        {/* Social Media Card */}
        <Card className="shadow-xl rounded-xl border-2 border-secondary/20 bg-gradient-to-bl from-card via-background to-muted/30 overflow-hidden transform transition-all duration-300 ease-in-out hover:shadow-2xl hover:-translate-y-1 hover:scale-[1.02]">
      ...
      {/* Feedback Section */}
      <Card className="mt-16 p-8 sm:p-10 bg-gradient-to-r from-accent/5 via-background to-accent/10 rounded-2xl shadow-2xl border-2 border-accent/30 text-center">
        ...
        <CardTitle className="text-3xl sm:text-4xl font-bold text-accent mb-5">We Value Your Voice</CardTitle>
